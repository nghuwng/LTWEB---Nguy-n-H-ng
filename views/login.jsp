            ...
            <div class="content-form-page">
              <div class="row">
                ...
                <c:if test="${alert !=null}">
                  ...
                  <form action="${pageContext.request.contextPath}/LoginServlet" method="post" class="form-horizontal form-without-legend" role="form">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0">
                        <a href="${pageContext.request.contextPath}/ForgotPasswordServlet">Forget Password?</a>
                      </div>
                    </div>
                    <div class="row">
